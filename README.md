...
<ul>
    ...
    <a href="https://en.wikipedia.org/wiki/Dynamic_programming" target="_blank">Programming Dinami - <h2>DP</h2></a>
      ...
      <ul>
          <li><a href="OTHERS/meu-troco.cpp">[1]</a><a href="OTHERS/meu-troco2.cpp">[2]</a><a href="OTHERS/meu-troco3.cpp">[3]</a><a href="UVA/357-let-count-the-ways.cpp">[4]</a> Véi, dá meu troco! - (DP - Coins)</li>
          ...
          <li><a href="UV/10131-is-bigger-smarter.cpp">[1]</a> UVA 10131 is bigger smarter?- (DP - Knapsack)</li>
      </ul>
    </li>
     <h2>Graph</h2>
      <ul>
      ...
      <h2>Pratice</h2>
      <ul>
          <li><a href="OBI/2007/fusões.cpp">[1]</a><a href="OTHERS/guildas.cpp">[2]</a> OBI Fusões - Guildas (Graph - Union Find)</li>
      </ul>
</ul>